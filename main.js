...
function openModal(project) {
    ...
    const docBtn = document.getElementById('mDoc');

    if (project.link === "") {
        linkBtn.href = "javascript:void(0)";       
        linkBtn.textContent = "Source Code Unavailable";
    ...
    if (project.doc === "") {
        ...
        docBtn.textContent = "Documentation Unavailable";
        docBtn.classList.add('doc-btn-disabled');
    } else {
        docBtn.href = project.doc;
        docBtn.textContent = "Read More";
        docBtn.classList.remove('doc-btn-disabled');
    }
